...
//         ...selectedIncident,
//         status: selectedEmployee ? 'Отправлено' : 'В ожидании',
//         set_employee: selectedEmployee.id,
//         set_employee_data: {
...
//   // Функция для удаления инцидента
//   const handleDeleteIncident = async () => {
//     if (selectedIncident) {
//       try {
//         await fetchApiWithAuth(`http://37.99.82.96:8000/api/v1/incident-web/${selectedIncident.id}`, {
//           method: 'DELETE',
//           headers: {
//             'Content-Type': 'application/json',
//           },
