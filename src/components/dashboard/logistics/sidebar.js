...
export function Sidebar({ currentIncidentId, onClose, onIncidentDeselect, onIncidentSelect, open, incidents }) {
  return (
    <Drawer
      anchor="top" // Drawer slides from the top
      PaperProps={{ sx: { width: '100%', height: '100%' } }} // Cover the full screen
      onClose={onClose}
      open={open}
    >
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        <Stack direction="row" spacing={2} sx={{ p: 2, alignItems: 'center', justifyContent: 'space-between' }}>
          <Typography variant="h5">Список инцидентов</Typography>
        ...
        <IncidentList
          ...
          onIncidentDeselect={onIncidentDeselect}
...
//           <Typography variant="h5">Список инцидент</Typography>
//           <IconButton onClick={onClose} sx={{ display: { md: 'none' } }}>
//             <XIcon />
//           </IconButton>
//         </Stack>
//         <Button variant="contained">
//           Сотрудники и патрульные машины-(айпи)
//         </Button>
//       </Stack>
//       <Divider />
