  ...
  const onSubmit = React.useCallback(
    async (_) => {
      try {
        ...
        router.push(paths.dashboard.incidents.list);
      } catch (err) {
        logger.error(err);
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <FormControl error={Boolean(errors.name)} fullWidth>
                            <InputLabel required>Названия</InputLabel>
                            <OutlinedInput {...field} />
                        ...
                        render={({ field }) => (
                          <FormControl error={Boolean(errors.category)} fullWidth>
                            ...
                            <Select {...field}>
                              ...
                              <Option value="Healthcare">Тест</Option>
                              <Option value="Makeup">Тест</Option>
                              <Option value="Skincare">Тест</Option>
                            </Select>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <FormControl error={Boolean(errors.type)} fullWidth>
                            ...
                            <Select {...field}>
                              <Option value="physical">Тест</Option>
                              <Option value="digital">Тест</Option>
                              <Option value="service">Тест</Option>
                            </Select>
                        ...
                        render={({ field }) => (
                          <FormControl error={Boolean(errors.name)} fullWidth>
                            ...
                            {errors.name ? (
                              ...
                              <FormHelperText>TТест</FormHelperText>
                            )}
                          </FormControl>
                        )}
                      />
                      ...
                      render={({ field }) => (
                        <FormControl error={Boolean(errors.currency)} sx={{ width: '150px' }}>
                          ...
                          <Select {...field}>
                            ...
                            <Option value="USD">Тест</Option>
                            <Option value="EUR">Тест</Option>
                            <Option value="RON">Тест</Option>
                          </Select>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <FormControl error={Boolean(errors.barcode)} fullWidth>
                            <InputLabel>Тест (EAN)</InputLabel>
            ...
            <Stack spacing={2}>
              {handle ? (
                <Typography color="primary.main" variant="subtitle2">
                  https://domain.com/incidents/{handle}
                </Typography>
              ) : (
