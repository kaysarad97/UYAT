export const paths = {
  home: '/dashboard/logistics/fleet',
  checkout: '/checkout',
  contact: '/contact',
  pricing: '/pricing',
  auth: {
  ...
  dashboard: {
    overview: '/dashboard/logistics/fleet',
    settings: {
    ...
    customers: {
      ...
      details: (id) => `/dashboard/customers/${id}`, // Этот маршрут должен соответствовать структуре папок
        },
    ...
    incidents: {
      ...
      create: '/dashboard/incidents/create',
      preview: (productId) => `/dashboard/incidents?previewId=${productId}`,
      details: (productId) => `/dashboard/incidents/${productId}`,
    },
    social: {
