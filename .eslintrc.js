...
module.exports = {
  ...
  rules: {
    ...
    "no-unused-vars": "off",  // Отключает правило для всех файлов
    "@typescript-eslint/no-unused-vars": "off", // Отключает правило для TypeScript
    'react/jsx-no-leaked-render': 'off',
    "camelcase": "off",
    'no-alert': 'off', // Отключает правило no-alert для всего проекта
    ...
    'prefer-template': 'off',
    'no-console': 'off', // Отключает правило глобально
    // Deactivated
